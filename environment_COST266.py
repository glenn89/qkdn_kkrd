...
class Request:
    ...
    def save_requests(self, filename="requests/NSFNET_requests_05.pkl"):
        with open(filename, "wb") as f:
            pickle.dump(self.requests, f)

    def load_requests(self, filename="requests/NSFNET_requests_05.pkl"):
...
if __name__ == "__main__":
    ...
    csv_file_path_2 = 'results/NSFNET_weighted_shortest_path_results_05_1-hop_10.csv'
