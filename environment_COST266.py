...
class Request:
    ...
    def save_requests(self, filename="requests/NSFNET_requests_0903_03.pkl"):
        with open(filename, "wb") as f:
            pickle.dump(self.requests, f)

    def load_requests(self, filename="requests/NSFNET_requests_0903_03.pkl"):
...
if __name__ == "__main__":
    ...
    # logging
    csv_file_path_1 = 'results/NSFNET_shortest_path_results_0902_03_20.csv'
    csv_file_path_2 = 'results/NSFNET_weighted_shortest_path_results_0902_03_20.csv'
